const fetchStations = require("./backend-controllers/fetchStations")
const fetchItems = require("./backend-controllers/fetchItems")
const mfyRouter = require("./load-balancers/MFY")
const fcRouter = require("./load-balancers/FC")
const cafeRouter = require("./load-balancers/CAFE")
const { fetchLastDTOrder, fetchLastFCOrder } = require('./backend-controllers/fetchOrders')
const createOrder = require("./backend-controllers/createOrder")
    ...
    */
    ...
    for (const item of newOrder.items) {
        ...
        if (categoryName === "Beef") {
            ...
            if (!relevantKVS.some(kvs => kvs.startsWith("MFY"))) {
